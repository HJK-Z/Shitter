...
class GAN():
    def __init__(self):
        ...
        # Input paths
        self.INPUT_IMAGES_PATH = os.path.join(self.CWD, r'Data\Input_Videos')
    ...
    def train_my_gan(self, epochs, batch_size=128, save_interval=50, save_model_epoch=5000):
        ...
        for epoch in range(epochs):
            ...
            print(imgs.shape, imgs_y.shape, np.ones((half_batch, 1)).shape)
...
if __name__ == '__main__':
    ...
    TOTAL_FRAMES = 1                         # Stop after creating n videos
